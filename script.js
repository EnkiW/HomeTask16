...
const displayMovies = (movies) => {
    ...
    movies.forEach((movie) => {
        ...
        const overview = document.createElement('p');
        overview.classList.add('my-p');
        overview.innerText = movie.overview.substring(0, 200) + '...';

        const moreDetailsBtn = document.createElement('button');
        moreDetailsBtn.innerText = 'Information';
        moreDetailsBtn.classList.add('my-button');
